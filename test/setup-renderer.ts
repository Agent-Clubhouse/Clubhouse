...
vi.stubGlobal('clubhouse', {
  ...
  agent: {
    ...
    resolvePendingPermission: async () => ({ status: 'resolved' }),
    onPermissionPending: () => noop,
  ...
  agentSettings: {
    ...
    getAgentWildcards: async () => null,
    listSourceMissions: async () => [],
    readSourceMissionContent: async () => '',
    writeSourceMissionContent: asyncNoop,
    deleteSourceMission: asyncNoop,
  ...
  groupProject: {
    ...
    saveRetentionConfig: async () => ({ saved: true, trimmed: 0 }),
    clearAllMessages: async () => ({ removed: 0 }),
  ...
  goobers: {
    getState: async () => null,
    validateRoot: async () => ({ ok: false }),
    connect: asyncNoop,
    disconnect: asyncNoop,
    listGaggles: async () => null,
    listWorkflows: async () => null,
    listRuns: async () => null,
    getRun: async () => null,
    getRunEvents: async () => null,
    getStageAttempts: async () => null,
    cancelRun: async () => null,
    daemonStatus: async () => null,
    daemonStart: async () => null,
    daemonStop: async () => null,
    openRunDir: async () => null,
    onStateChanged: () => noop,
    onDataInvalidated: () => noop,
  },
  commandPalette: {
    onRequest: () => noop,
    sendResult: noop,
