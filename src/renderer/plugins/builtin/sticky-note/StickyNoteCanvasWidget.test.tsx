...
describe('StickyNoteCanvasWidget', () => {
  ...
  it('has no separate Edit button — clicking the content area enters edit mode', () => {
    render(<StickyNoteCanvasWidget {...makeProps()} />);
    // No Edit button in the toolbar
    expect(screen.queryByTestId('sticky-note-edit')).toBeNull();
    // Clicking the content area switches to edit mode
  ...
  it('has no Save or Cancel buttons — mode is driven entirely by focus/blur', () => {
    render(<StickyNoteCanvasWidget {...makeProps()} />);
    fireEvent.click(screen.getByTestId('sticky-note-content'));
