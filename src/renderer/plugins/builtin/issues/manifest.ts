...
export const manifest: PluginManifest = {
  ...
  engine: { api: 0.5 },
  scope: 'project',
  permissions: ['process', 'notifications', 'commands', 'agents', 'events', 'widgets', 'storage'],
  allowedCommands: ['gh'],
  contributes: {
      ...
      topics: [
        {
          ...
          content: [
            ...
            '',
            '### Creating issues',
            '- **+ New** — Opens an inline form to create a new issue with title, body, and labels',
            '',
            '### Assigning to agents',
            ...
            '- Use **Set as default** to persist instructions across sessions (pre-populated on future runs)',
