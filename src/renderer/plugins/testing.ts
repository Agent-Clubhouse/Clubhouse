...
export function createMockAPI(overrides?: Partial<PluginAPI>): PluginAPI {
  return {
    ...
    agentConfig: {
      ...
      registerAgentTemplate: () => ({ dispose: () => {} }),
      contributeWrapperPreset: asyncNoop,
      removeWrapperPreset: asyncNoop,
    },
    sounds: {
    ...
    annex: {
      ...
      agentKill: asyncNoop,
      agentWake: asyncNoop,
      agentCreateDurable: asyncNoop as unknown as PluginAPI['annex']['agentCreateDurable'],
      agentDeleteDurable: asyncNoop as unknown as PluginAPI['annex']['agentDeleteDurable'],
      agentWorktreeStatus: asyncNoop as unknown as PluginAPI['annex']['agentWorktreeStatus'],
      ...
      fileTree: async () => [],
      fileRead: async () => '',
      gitOperation: asyncNoop as unknown as PluginAPI['annex']['gitOperation'],
      canvasMutation: asyncNoop,
      sessionList: asyncNoop as unknown as PluginAPI['annex']['sessionList'],
      sessionTranscript: asyncNoop as unknown as PluginAPI['annex']['sessionTranscript'],
      sessionSummary: asyncNoop as unknown as PluginAPI['annex']['sessionSummary'],
      gpGet: asyncNoop as unknown as PluginAPI['annex']['gpGet'],
      gpUpdate: asyncNoop as unknown as PluginAPI['annex']['gpUpdate'],
      gpBulletinDigest: async () => [],
      gpBulletinTopic: async () => [],
      gpBulletinAll: async () => [],
      gpBulletinPost: asyncNoop as unknown as PluginAPI['annex']['gpBulletinPost'],
      gpShoulderTap: asyncNoop as unknown as PluginAPI['annex']['gpShoulderTap'],
      gpDeleteMessage: async () => false,
