...
describe('agentStore', () => {
  ...
  describe('spawnQuickAgent with quick agent defaults', () => {
    ...
    it('falls back to project quickAgentClaudeMd when parent has no systemPrompt', async () => {
      ...
      mockAgent.getSettings.mockResolvedValue({ defaultClaudeMd: '', quickAgentClaudeMd: 'Project-level instructions' });
