...
export const useMcpSettingsStore = createSettingsStore(
  MCP_SETTINGS as import('../../shared/settings-definitions').SettingsDefinition<Record<string, unknown>> & typeof MCP_SETTINGS,
);
