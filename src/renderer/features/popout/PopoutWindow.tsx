...
export function PopoutWindow() {
  ...
  if (!params) {
    return (
      <div className={`h-screen w-screen ${rootBg} text-ctp-text flex items-center justify-center`}>
  ...
  return (
    <div className={`h-screen w-screen overflow-hidden ${rootBg} text-ctp-text flex flex-col`} data-testid="popout-window">
