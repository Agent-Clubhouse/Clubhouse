...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    topics: [
      { id: 'persona-project-manager', title: 'Project Manager Persona', content: personaProjectManager },
      { id: 'persona-qa', title: 'QA Reviewer Persona', content: personaQa },
      { id: 'persona-ui-lead', title: 'UI / Design Lead Persona', content: personaUiLead },
      { id: 'persona-slop-detector', title: 'Slop Detector Persona', content: personaSlopDetector },
      { id: 'persona-executor-pr-only', title: 'Executor (PR Only) Persona', content: personaExecutorPrOnly },
      { id: 'persona-executor-merge', title: 'Executor (Full Merge) Persona', content: personaExecutorMerge },
      { id: 'persona-doc-updater', title: 'Documentation Updater Persona', content: personaDocUpdater },
    ],
  },
];
